...
<div align="center"><img src="images/top2.gif" width="992" height="27">
</div>
 <table width="200" border="0" align="center">
  <tr>
    <td height="35"><div align="center">
     
	 <?php echo'<br><a href="deletecomparison.php?compid='.$_POST['id'] .'">Delete comparison</a><hr>';?>
    </div></td>
  </tr>
</table>
<p align="left"><br>
...
<div align="center">
  ...
  <iframe src="Admincomment.php?pseudo=<?php echo $pseudo ; ?>&comp_id=<?php echo $id ; ?>&userid=<?php echo $_SESSION['userid']; ?>" width="900"  height="800" align="middle" frameborder="0" id="comment_frame"></iframe>

</div>
<!--  
<div align="center" > <a href="feed.php?id=<?php echo $id ; ?>" alt="ATOM feed link" TITLE ="ATOM link : http://<?php echo $_SERVER['HTTP_HOST'] ?>/feed.php?id=<?php echo $id ; ?>"  ><img src="images/feed-icon.gif" width="48" height="48" border="0"></a> 
</div>

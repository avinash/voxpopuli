...
<?php echo'<br><a href="deletecomment.php?id='.$id. '&pseudo='. $_REQUEST['pseudo'].'&comp_id=' .$_REQUEST['comp_id'] .'&userid=' .$_REQUEST['userid'].'">Delete comment</a><hr>';?>
...
if($maxPage > 1)
{
	...
	{
		$nextLink[] =  "<a href=\"$self?page=$page&comp_id=" .$_REQUEST['comp_id'] ."\">$page</a>";
	}
